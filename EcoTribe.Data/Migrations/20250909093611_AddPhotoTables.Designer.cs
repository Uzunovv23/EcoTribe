...
namespace EcoTribe.Data.Migrations
{
    ...
    [Migration("20250909093611_AddPhotoTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcoTribe.BusinessObjects.Domain.Models.EventPhoto", b =>
                {
                    ...
                    b.Property<int?>("EventVolunteerId")
                        .HasColumnType("integer");

                    b.Property<int>("Id")
                        .HasColumnType("integer");

                    b.HasKey("EventId", "PhotoId");

                    b.HasIndex("EventVolunteerId");
            ...
            modelBuilder.Entity("EcoTribe.BusinessObjects.Domain.Models.OrganizationPhoto", b =>
                {
                    b.Property<int>("OrganizationId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("OrganizationId", "PhotoId");
            ...
            modelBuilder.Entity("EcoTribe.BusinessObjects.Domain.Models.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EcoTribe.BusinessObjects.Domain.Models.UserOrganization", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EcoTribe.BusinessObjects.Domain.Models.VolunteerPhoto", b =>
                {
                    b.Property<int>("VolunteerId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("VolunteerId", "PhotoId");

                    b.HasIndex("PhotoId");

                    b.ToTable("VolunteerPhotos");
                });
            ...
            modelBuilder.Entity("EcoTribe.BusinessObjects.Domain.Models.EventPhoto", b =>
                {
                    ...
                    b.HasOne("EcoTribe.BusinessObjects.Domain.Models.EventVolunteer", null)
                        .WithMany("EventPhotos")
                        .HasForeignKey("EventVolunteerId");

                    b.HasOne("EcoTribe.BusinessObjects.Domain.Models.Photo", "Photo")
                        .WithMany("EventPhotos")
            ...
            modelBuilder.Entity("EcoTribe.BusinessObjects.Domain.Models.Organization", b =>
                {
                    ...
                    b.Navigation("OrganizationPhotos");
